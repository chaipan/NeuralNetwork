...
It's probably because I didn't dimensionss choose the right kernels for rgb images.
kernels for rgb images have  3 x 3 x 3 x 3
...
from TensorFlow import kernels
